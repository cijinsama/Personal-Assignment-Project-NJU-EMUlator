...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0011000 00010 00000 000 00000 11100 11", mret   , N, s->dnpc = csr.mepc; is_exception_add_pc(); csr.mstatus.decode.MIE = csr.mstatus.decode.MPIE, csr.mstatus.decode.MPIE = 1);
